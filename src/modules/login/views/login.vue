  ...
  <div id="login">
    <div class="login-title">
      <div class="login-title-logo">
        <img class="login-title-logo-svg"
             src="../assets/img/login/bayes-logo.svg"
             alt="bayes_logo">
      </div>
    ...
    <div class="login-container">
      <b-tabs height="45px"
        ...
        <sign-in v-show="currentTab === 'left'"
                 slot="b-tabs-body"></sign-in>
        <sign-up v-show="currentTab === 'right'"
                 slot="b-tabs-body"></sign-up>
      </b-tabs>
      <pwd-retrieve v-else></pwd-retrieve>
    </div>
    <!-- <div class="login-copyright">
      copyright &copy; 2019 脉云软件
    </div> -->
    <!--    usage-protocol-->
    <!-- <el-dialog
      title="使用条款"
